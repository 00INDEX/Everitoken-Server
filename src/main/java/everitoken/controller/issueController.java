...
public class issueController {
    ...
    @ResponseBody
    public Object IssueBattery(@RequestBody Map<String,Object>data){//function:获取授权记录 need:生产商ID、电池名称、电池类型,电池循环充放电次数
        ...
        BatteryName = data.get("Battery_Name").toString();
        ...
        if(data.containsKey("name")) batteryEntity.setUid(Integer.parseInt(data.get("name").toString()));
